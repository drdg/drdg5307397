...
public class RectMutiConvertor extends HtmlDomConvertor {

	@Override
	public String convertHtml(int index, Question question) {
		if (TYPE_ARRAYMULTI == question.getType()) {
            ...
            for (int i = 0; i < titleArray.length; i++) {
                ...
                for (int j = 0; j < optionArray.length; j++) {
                    buffer.append("<td><input type=checkbox name=").append(getDomName(index, false)).append(" value=").append(j).append("></td>");
