...
$.extend({
	webox:function(option){
		...
		$(document).ready(function(e){
			...
			$('body').append('<div class="background" style="display:none;"></div><div class="webox" style="width:'+width+'px;height:'+height+'px;display:none;"><div id="inside" style="height:'+height+'px;">'+(option['iframe']?'<iframe class="w_iframe" src="'+option['iframe']+'" frameborder="0" width="100%" scrolling="auto" style="border:none;overflow-x:hidden;hidden;height:'+height+'px;"></iframe>':option['html']?option['html']:'')+'</div></div>');
