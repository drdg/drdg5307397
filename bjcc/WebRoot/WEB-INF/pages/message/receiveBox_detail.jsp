			...
			<table width="741px;"  height="30" border="0" cellspacing="0" style="background:#fef8e6; color:#4f4f4f;">
				<tr>
			    	 <td style="width:100px; padding-left: 10px">
				    	<a href="#" onclick="transfer(<s:property value="receiveMsgId"/>)" class="xhx">转发</a>&nbsp;&nbsp;
				    	<a href="#" onclick="reply(<s:property value="receiveMsgId"/>)" class="xhx">回复</a>&nbsp;&nbsp;
				    	<a href="#" onclick="del(<s:property value="receiveMsgId"/>);" class="xhx">删除</a>&nbsp;&nbsp;
				    	<a href="#" onclick="back();" class="xhx">返回</a>
			        </td>
				</tr>
			</table>
				<strong>发信人：</strong>
			 	<s:property value="receiveMessage.websiteMessage.sendUsername" /><br/><br/>			    	
				<strong>发信时间：</strong>
			 	 <s:property value="receiveMessage.websiteMessage.sendTime" />	<br/><br/>		    	
				<strong>收信人：</strong>
			 	<s:property value="receiveMessage.receiveName" /><br/><br/>			    	
				<strong>主题：</strong>
			 	<b><s:property value="receiveMessage.websiteMessage.msgTitle" /></b><br/><br/>		    	
				<strong>内容： </strong>
				<div style="width: 450px;margin-left: 40px;"><s:property value="receiveMessage.websiteMessage.msgContent" /></div>
		</div>
	</div>
</div>
</form>
