	...
	<!--ct1--> 
	 ...
	 <div class="study_ct">
			 <div class="study_ct_left"> 
				<div style="z-index:-1;">
				<iframe src="${pageContext.request.contextPath }/excusePersonal.action" name="leftframe" frameBorder="0" scrolling="no" marginwidth="0"
						marginheight="0" id="leftframe" width="100%" height="310" border="0"> </iframe>
				</div>
				</div>
	<div class="study_ct_right">
		<div class="xxjh">
				<iframe id="naire" name="naire" src="${pageContext.request.contextPath }/queryMoreQuestionNaireAction.action" frameBorder="0" scrolling="no" marginwidth="0"
						marginheight="0" id="leftframe" width="100%" height="310" border="0"> </iframe>
		</div>
	</div>
