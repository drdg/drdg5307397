...
<div class="zytj_ct" id="main2">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" >
    <tr>
      <td><div class="zytj_img">
        <ul>
          <li><a href="#"><img src="${pageContext.request.contextPath }/images/video_img.jpg" border="0" /></a><br />
            <a href="#">社区情缘</a><p><a href="#"><img src="${pageContext.request.contextPath }/images/jrxxjh_bt.png" /></a><a href="#"><img src="${pageContext.request.contextPath }/images/sc_bt.png" /></a></p></li>
          <li><a href="#"><img src="${pageContext.request.contextPath }/images/video_img.jpg" border="0" /></a><br />
            <a href="#">用平凡唱响生命之歌</a><p><a href="#"><img src="${pageContext.request.contextPath }/images/jrxxjh_bt.png" /></a><a href="#"><img src="${pageContext.request.contextPath }/images/sc_bt.png" /></a></p></li>
          <li><a href="#"><img src="${pageContext.request.contextPath }/images/video_img.jpg" border="0" /></a><br />
            <a href="#">社区情缘</a><p><a href="#"><img src="${pageContext.request.contextPath }/images/jrxxjh_bt.png" /></a><a href="#"><img src="${pageContext.request.contextPath }/images/sc_bt.png" /></a></p></li>
          <li><a href="#"><img src="${pageContext.request.contextPath }/images/video_img.jpg" border="0" /></a><br />
            <a href="#">wowow</a><p><a href="#"><img src="${pageContext.request.contextPath }/images/jrxxjh_bt.png" /></a><a href="#"><img src="${pageContext.request.contextPath }/images/sc_bt.png" /></a></p></li>
          <li><a href="#"><img src="${pageContext.request.contextPath }/images/video_img.jpg" border="0" /></a><br />
            <a href="#">用平凡唱响生命之歌</a><p><a href="#"><img src="${pageContext.request.contextPath }/images/jrxxjh_bt.png" /></a><a href="#"><img src="${pageContext.request.contextPath }/images/sc_bt.png" /></a></p></li>
        </ul>
        
      </div>  <div class="zytj_more"><a href="#">全部资源&nbsp;<img src="${pageContext.request.contextPath }/images/gs_xb.gif" /></a></div></td>
    </tr>
  </table>
