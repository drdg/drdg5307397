...
a.login_word{ color:#fe0000; font-weight:bold; text-decoration:none;}
a.login_word:hover{ color:#fe0000; font-weight:bold; text-decoration:underline;}
a.login_word1{ color:#000;  text-decoration:none;}
a.login_word1:hover{ color:#fe0000; text-decoration:underline;}
...
<!--head--> 
	...
	<div class="head">
	  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="color:#7f7f7f;">
        <tr>
          <td height="26" align="left" valign="middle">您好，欢迎光临北京长城网！</td>
          <td height="26" align="center" valign="middle">用户【<a href="#" class="login_word1">test _124</a>】欢迎您，您有<a href="#" class="login_word">24</a>条短消息！您可以【<a href="#" class="login_word1">进入个人空间首页</a>】或【<a href="#" class="login_word1">退出登录</a>】</td>
	...
	<!--<div class="search">
	  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="35" align="left" valign="middle" style="font-size:14px; color:#d30101; font-weight:bold; "><img src="images/sc_icon.gif" width="14" height="11" />站内搜索</td>
          <td height="35" align="left" valign="middle"><a href="#"></a> <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="60" align="left" valign="middle"><a href="#"><img src="images/sc_bt.gif" width="43" height="22" border="0" /></a></td>
              </tr>
            </table></td>
          <td width="120" height="35" align="left" valign="middle" style="font-size:14px; color:#d30101; font-weight:bold; "><img src="images/sc_icon.gif" width="14" height="11" />人事任免动态</td>
