...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="news1" style=" margin-bottom:8px;">
				 <tr>
				  ...
				  <td width="147" align="right" background="${pageContext.request.contextPath }/images/news2_bg.gif"><a href="#">更多&gt;&gt;</a>  </td>
				 </tr>
				 <tr>
				  <td colspan="2" style="border-top:1px solid #D6D6D6;">
				   <div class="news_list_1">
					<ul>
					 <li><a href="#" class="huida">[回答]</a> <a href="#">大学生村干部在创大学生村干部在创先争优大学生村干部在创先争优先争优</a></li>
					 <li><a href="#" class="huida">[回答]</a> <a href="#">大学生村干部在创大学生村干部在创先争优大学生村干部在创先争优先争优</a></li>
					 <li><a href="#" class="huida">[回答]</a> <a href="#">大学生村干部在创大学生村干部在创先争优大学生村干部在创先争优先争优</a></li>
					 <li><a href="#" class="huida">[回答]</a> <a href="#">大学生村干部在创大学生村干部在创先争优大学生村干部在创先争优先争优</a></li>
					 <li><a href="#" class="huida">[回答]</a> <a href="#">大学生村干部在创大学生村干部在创先争优大学生村干部在创先争优先争优</a></li>
